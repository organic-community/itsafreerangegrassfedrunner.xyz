    ...
    <div className="h-screen overflow-hidden bg-gradient-to-br from-green-50 via-lime-50 to-emerald-50">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 h-[calc(100vh-80px)] overflow-y-auto pt-2 sm:pt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <a 
            href="https://v0-flappy-cow.vercel.app" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="group block"
          >
            <div className="bg-gradient-to-br from-red-100 to-rose-100 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-rose-200 shadow-lg active:shadow-xl transition-all duration-300 active:scale-95 sm:hover:scale-105 group-hover:from-red-200 group-hover:to-rose-200 h-full min-h-[180px] sm:min-h-[200px]">
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4 group-hover:animate-bounce">🪽</div>
              <h3 className="text-lg sm:text-xl font-bold mb-2 text-gray-800">Flappy Cow</h3>
              <div className="flex items-center gap-2 text-[11px] sm:text-xs text-gray-500 mb-2">
                <span className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse" />
                <span><PlaysCounter min={150} max={999} /> plays</span>
              </div>
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 line-clamp-2">Tap to glide through the pasture. Don’t bonk the pipes.</p>
              <div className="flex items-center gap-2 text-rose-700 font-semibold text-xs sm:text-sm">
                <span>Play Now</span>
                <svg className="w-3 h-3 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
          ...
          <a 
            href="https://v0-online-chat-application-mauve.vercel.app/" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="group block"
          >
            <div className="bg-gradient-to-br from-violet-100 to-fuchsia-100 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-violet-200 shadow-lg active:shadow-xl transition-all duration-300 active:scale-95 sm:hover:scale-105 group-hover:from-violet-200 group-hover:to-fuchsia-200 h-full min-h-[180px] sm:min-h-[200px]">
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4 group-hover:animate-bounce">💬</div>
              <h3 className="text-lg sm:text-xl font-bold mb-2 text-gray-800">Moo-Chat Pasture</h3>
              <div className="flex items-center gap-2 text-[11px] sm:text-xs text-gray-500 mb-2">
                <span className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse" />
                <span><PlaysCounter min={140} max={999} /> plays</span>
              </div>
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 line-clamp-2">Chat in the pasture with fellow cows. Mooo together.</p>
              <div className="flex items-center gap-2 text-violet-700 font-semibold text-xs sm:text-sm">
                <span>Open Chat</span>
                <svg className="w-3 h-3 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
